  ...
  return (
    <div className="flex-1 overflow-y-auto p-4">
      ...
      {hasCredentials ? (
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="shrink-0 rounded-md bg-green-600 px-4 py-2 text-sm font-normal text-white hover:bg-green-700 disabled:opacity-50"
            >
              {isAdding ? "Adding..." : "Add"}
            </button>
          </div>
        ...
        <button
          onClick={onShowSetup}
          className="w-full rounded-md border border-green-300 bg-green-50 px-4 py-2 text-sm font-normal text-green-700 hover:bg-green-100 dark:border-green-600 dark:bg-green-900/20 dark:text-green-400 dark:hover:bg-green-900/30"
        >
