    ...
    <div>
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3 md:mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {isSyncingAny ? (
              <svg className="h-5 w-5 animate-spin md:mr-2 md:h-4 md:w-4" fill="none" viewBox="0 0 24 24">
            ...
            <span className="hidden text-sm font-normal md:inline">
              {isSyncingAny ? "Checking..." : "Check All"}
            </span>
          </button>
          ...
          >
            ...
            <span className="hidden text-sm font-normal md:inline">Add Repository</span>
          </button>
        </div>
      </div>
